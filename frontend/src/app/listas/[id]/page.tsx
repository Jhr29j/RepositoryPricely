...
export default function ListasPage() {
  ...
  const handleQuitarProducto = async (idDetalle: number, idLista: number) => {
    try {
      ...
      setListas(prev => prev.map(l => l.id_lista === idLista ? updated : l))
  ...
  return (
    <div>
      ...
      <div className="listas-header">
        <h1>MIS LISTAS</h1>
        <button className="btn-primary" style={{ padding: '0.5rem 1.2rem', borderRadius: 20, fontSize: '0.88rem' }}
          ...
          <div className="lista-card animate-fade-up" style={{ padding: '1.2rem' }}>
            ...
            <div style={{ display: 'flex', gap: '0.8rem' }}>
              <input
                ...
                autoFocus
              />
              <button className="btn-primary" style={{ padding: '0 1.2rem', borderRadius: 8 }} onClick={handleCrear}>
                Crear
              </button>
          ...
          <div key={lista.id_lista} className={`lista-card animate-fade-up stagger-${Math.min(li+1,5)}`}>
            ...
            <div className="lista-card-header">
              ...
              <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                ...
                <button
                  onClick={() => handleEliminar(lista.id_lista, lista.nombre)}
            ...
            <div className="lista-total">
              Total estimado: RD${lista.total.toFixed(2)}
            </div>
          </div>
        ))}
      </div>
